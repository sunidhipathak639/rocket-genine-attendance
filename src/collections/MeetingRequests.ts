            ...
            if (assignedTechnicalStaff) {
              ...
              await req.payload.create({
                ...
                data: {
                  ...
                  body: `Requested By: ${(staffMember as any)?.name || 'Staff Member'}\nTopic: ${doc.topic}\nAgenda: ${doc.description || 'No description provided'}`,
                  type: 'meeting',
                  read: false,
                },
                req,
            ...
            if (doc.status === 'scheduled' && previousDoc.status !== 'scheduled') {
              ...
              await req.payload.create({
                ...
                data: {
                  ...
                  body: `Topic: ${doc.topic}\nAgenda: ${doc.description || 'No description provided'}\nWith: ${(technicalStaff as any)?.name || 'Technical Staff'}\nTime: ${format(new Date(doc.scheduledDate), 'PPP p')}`,
              ...
              if (doc.technicalStaff) {
                await req.payload.create({
                  ...
                  data: {
                    ...
                    body: `Topic: ${doc.topic}\nAgenda: ${doc.description || 'No description provided'}\nWith: ${(staffMember as any)?.name || 'Staff Member'}\nTime: ${format(new Date(doc.scheduledDate), 'PPP p')}`,
                    link: doc.meetingLink,
                    type: 'meeting',
                    read: false,
                  },
              ...
              for (const admin of admins.docs) {
                await req.payload.create({
                  ...
                  data: {
                    ...
                    title: 'Meeting Scheduled',
                    message: `Meeting "${doc.topic}" has been scheduled`,
                    body: `Topic: ${doc.topic}\nAgenda: ${doc.description || 'No description provided'}\nAttendees: ${(staffMember as any)?.name} & ${(technicalStaff as any)?.name}\nTime: ${format(new Date(doc.scheduledDate), 'PPP p')}`,
                    link: doc.meetingLink,
                    type: 'meeting',
                    read: false,
                  },
